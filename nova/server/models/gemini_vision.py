...
CLIP_PROMPT = (
    ...
    "СТРОГО: 1) элементы интерфейса (иконки, панели, бан-листы, "
    "портреты) — НЕ участники событий; действием считай только то, что "
    "реально происходит в кадре. 2) Имена персонажей называй ТОЛЬКО "
    "когда они видны ником/подписью; не уверена — описывай внешне "
    "(«блондинка в белом»). Никаких догадок об именах. 3) Цифры "
    "интерфейса подписывай их смыслом, если он ясен из контекста, "
    "иначе просто «число N у прицела/вверху». {hint}"
)
