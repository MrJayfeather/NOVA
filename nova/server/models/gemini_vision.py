...
DESCRIBE_PROMPT = (
    ...
    "Если кадр почти не отличается от предыдущего — пиши «N: то же». "
    "ВАЖНО: заголовки/названия видео и каналов — это контекст, а НЕ "
    "утверждение о том, кто в кадре: имя из заголовка не приклеивай к "
    "человеку на экране; людей без явной подписи описывай по виду. "
    "Пример ошибки: заголовок «...w/ BIG RUSSIAN BOSS», в кадре парень "
    "с синими волосами -> НЕЛЬЗЯ писать «BRB с синими волосами», "
    "правильно: «парень с синими волосами». {prev}"
)
